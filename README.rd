...
## Why && Features
I created this script to overcome some of issues I found using the standard TestExecute interface as the impossibility to run single test cases instead of projects, and to have a tool that is easy to use and easier to integrate with other test automation scripts.
